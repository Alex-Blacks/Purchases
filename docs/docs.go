...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.ItemDetailsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/private/orders/{orderId}/items/{productId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ProductFindResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/private/products/{productId}/aliases": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "product alias payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ProductAliasRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/private/products/{productId}/aliases/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "dto.OrderWithItemDetailsResponse": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
